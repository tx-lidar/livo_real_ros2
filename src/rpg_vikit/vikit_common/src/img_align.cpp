...
ForwardCompositionalSE3::ForwardCompositionalSE3(
    ...
    Sophus::SE3 &init_model, int n_levels, int n_iter, float res_thresh,
...
void ForwardCompositionalSE3::runOptimization(Sophus::SE3 &model,
...
double ForwardCompositionalSE3::computeResiduals(const Sophus::SE3 &model,
...
double SecondOrderMinimisationSE3::computeResiduals(const Sophus::SE3 &model,
                                                    bool linearize_system,
                                                    bool compute_weight_scale) {
  // Warp the image such that it aligns with the template image
  double chi2 = 0;
